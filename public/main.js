$(function() {
  ...
  const addPreviousMessages = (data) => {
  ...
  const addChatMessage = (data, options) => {
    ...
    const localeDate = new Date(data.timestamp - new Date().getTimezoneOffset() * 60 * 1000);
    const localeTime = /T([^.]+)/.exec(localeDate.toISOString())[1];
